            ...
            <footer className="  bg-[#101010] z-10  ">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 z-10">
                    <div className="md:flex md:justify-between tablet:justify-center z-10">
                        ...
                        <div className=" flex  flex-col gap-5 mb-6 max-w-[40%] tablet:max-w-[100%] tablet:items-center  md:mb-0">
                            <Link   to="/" className="flex items-center">
                                ...
                                {/* <span className="self-center text-primary-gradient text-4xl font-bold whitespace-nowrap  text-white">GrtPay Finance</span> */}
                            </Link>
                            <p className=" tablet:text-center " > GrtPay Finance ecosystem, with its dynamic professional map, redefines accreditation and certification, setting global standards for excellence in people management through innovation, collaboration, and transformative change.</p>
                    ...
                    <div className="sm:flex sm:items-center tablet:text-center sm:justify-between">
                        <span className="text-sm   sm:text-center  text-gray-400">© 2024 <a href="" className="hover:underline">GrtPay </a> . All Rights Reserved.
                        </span>
